...
public class UsuarioService extends BaseService<Usuario> {
	...
	public Usuario salvar(Usuario usuario) {
		...
		if (Strings.isEmpty(usuario.getSenha())) {			
			throw new ValidacaoException("Senha eh obrigatoria!");
		}
	...
	public List<Usuario> buscarPor(String email, String nome) {
		...
		//for (int i: i <= resultados
		// TODO: Filtrar usuarios pelo nome recebido
		// TODO: Ordenar por email, nome

		// Dica: Usar a classe auxiliar Strings para verificar se o 
		//parametro esta vazio. Ver metodo "salvar"
